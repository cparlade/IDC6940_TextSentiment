...
subtitle: "How does the sentiment in headline news affect the S&P 500 index price?"
author: "Christian Parlade (Advisor: Dr. Cohen)"
date: today                     # replaces `r Sys.Date()` so R isn't required
jupyter: python3
freeze: auto
...
format:
  revealjs:
    self-contained: true        # valid under revealjs
    slide-number: true
    incremental: true
    code-fold: false
